...
class TenantsControllerTest < ActionController::TestCase
  ...
  test "should create tenant" do
    assert_difference('Tenant.count') do
      post :create, tenant: { domain_url: @tenant.domain_url, name: @tenant.name, schema_name: @tenant.schema_name }
    end
  ...
  test "should update tenant" do
    put :update, id: @tenant, tenant: { domain_url: @tenant.domain_url, name: @tenant.name, schema_name: @tenant.schema_name }
    assert_redirected_to tenant_path(assigns(:tenant))
  end
